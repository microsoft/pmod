...
namespace propertymodelcore
{
    ...
    /// <summary>
    /// Root.Core.Model.PropertyModel
    /// </summary>
    public enum PropertyModel_Category
    {
        Invoke,
        GetProperty,
        SetProperty
    ...
    [EnumBaseType(BaseType = typeof(Model_LogRecord))]
    public enum PropertyModelInvoke_LogRecord
    {
        Parameters,
        MethodId,
        MethodInfo,
    ...
    [EnumBaseType(BaseType = typeof(Model_LogRecord))]
    public enum PropertyModelGetProperty_LogRecord
    {
        PropertyId,
    }

    [EnumBaseType(BaseType = typeof(Model_LogRecord))]
    public enum PropertyModelSetProperty_LogRecord
    {
        PropertyId,
    }
